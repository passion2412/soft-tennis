...
# ページ設定
st.set_page_config(page_title="Tennis Stats Final v2", layout="centered")
...
<body>
    ...
    <div class="report-card">
        ...
        <table>
            ...
            <tr><td>相手のエース</td><td id="opp-ace-count">0</td></tr>
            <tr><td>相手のミス</td><td id="opp-miss-count">0</td></tr>
        </table>
